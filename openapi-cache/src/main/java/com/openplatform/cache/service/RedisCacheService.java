...
public interface RedisCacheService {
     ...
     * @param increment
     */
    long incrByString(String key, int increment);
     ...
     * @param decrement
     */
    long decrByString(String key, int decrement);
     ...
     * @return
     */
    Map<Object, Object> hGetHashAll(String key);
     ...
     * @return
     */
    long sAddSet(String key, Object member);
     ...
     * @return
     */
    long sAddSetAll(String key, List<Object> members);
     ...
     * @return
     */
    Set<Object> sMembersSetAll(String key);
